...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        KC_TAB, KC_Q, KC_L, KC_W, KC_P, KC_B, KC_J, KC_F, KC_U, KC_O, KC_SCLN, KC_BSPC,
        KC_ESC, KC_M, KC_R, KC_S, KC_T, KC_G, KC_Y, KC_N, KC_E, KC_A, KC_I, KC_QUOT,
        KC_LSFT, KC_K, KC_X, KC_C, KC_D, KC_V, KC_Z, KC_H, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
