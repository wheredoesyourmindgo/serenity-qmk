...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NUMNAV] = LAYOUT(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, KC_ESC, KC_ENT, ENC_BTN, KC_SPC, LT(AUX, KC_TAB), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[SYMBL] = LAYOUT(
	...
	[AUX] = LAYOUT(
        ...
        TD(TD_OOPS), KC_NO, XOSM_RALT, KC_NO, LT(NUMNAV, KC_ESC), KC_ENT, ENC_BTN, KC_SPC, KC_TAB, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HRDWR] = LAYOUT(
