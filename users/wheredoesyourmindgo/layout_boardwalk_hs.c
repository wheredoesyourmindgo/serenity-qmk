...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_Z, KC_L, KC_M, KC_F, KC_Q, KC_LBRC, KC_RBRC, KC_X, KC_W, KC_O, KC_U, KC_MINS, KC_BSPC,
        LT(LOWEST, KC_GRV), KC_S, KC_R, KC_T, KC_N, KC_P, KC_HOME, KC_PGUP, KC_Y, KC_D, KC_E, KC_I, KC_A, KC_SCLN,
        KC_LSFT, KC_V, KC_J, KC_K, KC_H, KC_B, KC_END, KC_PGDN, KC_G, KC_C, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_BSLS, KC_SLSH, KC_EQL, KC_LCBR, KC_RCBR, KC_SCLN,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PIPE, KC_QUES, KC_PLUS, KC_LBRC, KC_RBRC, KC_CAPS,
