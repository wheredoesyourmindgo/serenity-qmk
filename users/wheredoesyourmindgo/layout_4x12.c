...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12(
        ...
        LT(MEDIA,KC_GRAVE), ALPH_R2C1, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, ALPH_R2C10, LT(KBRD,KC_QUOT),
    ...
    [BASE_QWRTY] = LAYOUT_4x12(
        ...
        LT(MEDIA,KC_GRAVE), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LT(KBRD,KC_QUOT),
	...
	[HIGHER] = LAYOUT_4x12(
        CMD_TAB_HIDE, OS_PRV_TAB, OS_PRVS_APP_WNDW, OS_NXT_APP_WNDW, OS_NXT_TAB, TD(TD_TGL_SEL), LALT(OS_SPTLGHT), OS_SPTLGHT, OS_LNCHPD, OS_SIRI, OS_SDBR, CMD_TAB_QUIT,
        KC_NO, OS_PRV_SPC, OS_DSKTP, OS_MSN_CNTRL, OS_NXT_SPC, OS_FLLSCRN, DF(HIGHER), OS_TRM_VSR, OS_LNCHR, KC_NO, KC_NO, KC_NO,
        KC_NO, CMD_TAB_PRV, OS_DOCK, OS_EXPOSE, CMD_TAB_NXT, PRV_APP, KC_NO, LALT(KC_TAB), KC_NO, KC_NO, KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, TD(TD_LOWER_ESC), KC_ENT, KC_TAB, DF(BASE), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HIGH] = LAYOUT_4x12(
        LALT(KC_DEL), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSPC,
        KC_GRV, WNDW_LFT_HLF, WNDW_BTTM_HLF, WNDW_TOP_HLF, WNDW_RGHT_HLF, WNDW_MAX, DF(HIGH), KC_NO, LALT(KC_TAB), KC_NO, KC_NO, KC_NO,
        LSFT_T(KC_CAPS), KC_NO, WNDW_SMLLR, WNDW_LRGR, KC_NO, XWNDW_CNTR, WNDW_RSTR,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, DF(BASE), KC_SPACE, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[HIGHEST] = LAYOUT_4x12(
        KC_DEL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_BSPC,
        KC_GRV, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_NO,
        KC_LSFT, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DF(HIGHEST), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DF(BASE)
    ),
	[MEDIA] = LAYOUT_4x12(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OS_SCRN_SHT_OPT, OS_DRKMD_TGL, DISP_DIM, DISP_BRI, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, KC_NO,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MRWD, MAC_MSTP, KC_MPLY, KC_MFFD, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, KC_TAB, KC_SPACE, KC_NO, KC_NO, KC_NO, KC_NO
    ),
	[KBRD] = LAYOUT_4x12(
        RESET, KC_NO, RGB_HUD, RGB_HUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        DEBUG, RGB_RMOD, RGB_VAD, RGB_VAI, RGB_MOD, RGB_TOG, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_LSFT, KC_NO, RGB_SAD, RGB_SAI, KC_NO, TGL_LYT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, KC_TAB, KC_SPACE, KC_NO, KC_NO, KC_NO, KC_NO
    )
};
