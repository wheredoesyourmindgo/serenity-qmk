...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_B, KC_Y, KC_F, KC_W, KC_P, KC_LBRC, KC_RBRC, KC_J, KC_L, KC_U, KC_Q, KC_SCLN, KC_BSPC,
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, BTN1_HOLD, KC_BTN1, KC_BTN3, KC_BTN2, KC_NO, KC_BSPC,
