...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_Z, KC_J, KC_H, KC_K, KC_Q, KC_LBRC, KC_RBRC, KC_QUOT, KC_W, KC_O, KC_U, KC_EQL, KC_BSPC,
        KC_X, KC_S, KC_R, KC_N, KC_T, KC_M, KC_HOME, KC_PGUP, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_MINS,
        KC_LSFT, KC_F, KC_L, KC_B, KC_D, KC_V, KC_END, KC_PGDN, KC_G, KC_P, KC_GRV, KC_COMM, KC_DOT, KC_RSFT,
