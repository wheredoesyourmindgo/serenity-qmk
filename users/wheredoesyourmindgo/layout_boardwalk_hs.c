...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_MINS), KC_Y, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_M, KC_N, KC_E, KC_I, KC_A, LT(HIGH,KC_QUOT),
        KC_LSFT, KC_V, KC_X, KC_W, KC_D, KC_Z, KC_END, KC_PGDN, KC_K, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_RSFT,
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER,KC_ESC), LT(LOW,KC_ENT), KC_SPC, LT(HIGHER,KC_TAB), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(HIGHEST,KC_RIGHT)
    ),
    [QWRTY] = LAYOUT_boardwalk_hs(
        KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_SLSH, KC_BSLS, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
        OS_DEL, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_LBRC, KC_RBRC, KC_Y, KC_U, KC_I, KC_O, KC_P, OS_BSPC,
        LT(LOWEST, KC_MINS), KC_A, KC_S, KC_D, KC_F, KC_G, KC_HOME, KC_PGUP, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LT(HIGH,KC_QUOT),
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_END, KC_PGDN, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, KC_RSFT,
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER,KC_ESC), LT(LOW,KC_ENT), KC_SPC, LT(HIGHER,KC_TAB), LT(HIGHEST, KC_SLSH), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
    ...
    [HIGH] = LAYOUT_boardwalk_hs(
        ...
        KC_CAPS, KC_NO, KC_MRWD, KC_MFFD, KC_MPLY, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DEBUG,
