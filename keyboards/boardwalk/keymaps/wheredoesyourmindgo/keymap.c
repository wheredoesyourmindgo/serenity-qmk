...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_SPC), LT(LOW,KC_ESC), /* <-2U  2U-> */ LT(HIGH,KC_ENT), LT(HIGHER,KC_TAB), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_SPC), LT(LOW,KC_ESC), /* <-2U  2U-> */ LT(HIGH,KC_ENT), LT(HIGHER_HRM,KC_TAB), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
	...
	[HIGHER] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LT(LOWER,KC_SPC), KC_SPC, /* <-2U  2U-> */ KC_ENT, DF(BASE), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	...
	[WNDW] = LAYOUT_ortho_2x2u(
        ...
        DF(BASE), KC_NO, WNDW_LFT_HLF,               WNDW_CNTR_HLF, WNDW_RGHT_HLF, KC_NO, KC_NO, KC_NO, WNDW_CNTR, WNDW_MV_LFT, WNDW_MV_DWN, WNDW_MV_UP, WNDW_MV_RGHT, WNDW_MAX,
