...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        KC_TAB, KC_Q, KC_L, KC_W, KC_P, KC_B, KC_J, KC_F, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_ESC, KC_M, KC_R, KC_S, KC_T, KC_G, KC_Y, KC_N, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_K, KC_H, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
	...
	[SYMBL] = LAYOUT(
        ...
        LT(MOUSE,KC_MUTE), KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), KC_SPC, ENC_BTN, KC_SPC, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[AUX] = LAYOUT(
        ...
        LT(MOUSE,KC_MUTE), KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), KC_SPC, ENC_BTN, LT(HRDWR,KC_SPC), MO(SYMBL), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [HRDWR] = LAYOUT(
        ...
        LT(MOUSE,KC_MUTE), KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), LT(AUX,KC_SPC), ENC_BTN, KC_SPC, MO(SYMBL), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[FUNC] = LAYOUT(
