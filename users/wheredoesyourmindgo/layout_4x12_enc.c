...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
            ...
            KC_DEL, KC_F, KC_L, KC_H, KC_K, KC_Q, KC_Z, KC_W, KC_O, KC_U, KC_MINS, KC_BSPC,
            KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_M, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_EQL,
            TD(TD_CAPS_WORD), KC_X, KC_J, KC_B, KC_D, KC_V, KC_G, KC_P, KC_QUOT, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
	...
	[LOW] = LAYOUT_4x12_enc(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH),  KC_PIPE,   KC_LABK, KC_LCBR,  KC_RCBR, KC_RABK, KC_EQL,
