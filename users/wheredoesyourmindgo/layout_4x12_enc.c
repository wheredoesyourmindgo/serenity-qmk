...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), TD(TD_LOWER_ESC), TD(TD_LOW_ENT), KC_MUTE,  LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
