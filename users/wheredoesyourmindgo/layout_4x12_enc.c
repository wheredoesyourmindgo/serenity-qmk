...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER,KC_ESC), LT(LOW,KC_ENT), ENC_BTN, LT(HIGH,KC_SPC), LT(HIGHER,KC_TAB), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(HIGHEST,KC_RIGHT)
    ),
    [QWRTY] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER,KC_ESC), LT(LOW,KC_ENT), ENC_BTN, LT(HIGH,KC_SPC), LT(HIGHER,KC_TAB), LT(HIGHEST, KC_SLSH), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	[LOWER] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, KC_ESC, KC_ENT, ENC_BTN, KC_SPC, LT(HIGHER, KC_TAB), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[LOW] = LAYOUT_4x12_enc(
    ...
    [LOWEST] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPS), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, KC_ENT, ENC_BTN, KC_SPC, KC_TAB, KC_NO, XOSM_RALT, KC_NO, KC_NO
    #else
        OS_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN5, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, OS_BSPC,
        KC_GRV, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, LLOCK,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, SHAKE_MOUSE, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_RSFT,
	...
	[HIGHER] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPS), KC_NO, XOSM_RALT, KC_NO, LT(LOWER, KC_ESC), KC_ENT, ENC_BTN, KC_SPC, KC_TAB, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HIGH] = LAYOUT_4x12_enc(
        TGL_LYT, KC_NO, DISP_DIM, DISP_BRI, OS_DRKMD_TGL, KC_NO, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RESET,
        KC_GRV, KC_NO, KC_VOLD, KC_VOLU, KC_MUTE, KC_NO, LLOCK, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DEBUG,
	...
	[HIGHEST] = LAYOUT_4x12_enc(
        ...
        TD(TD_OOPS), KC_RCTL, XOSM_RALT, KC_RGUI, KC_ESC, KC_ENT, ENC_BTN, KC_SPC, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO
    ),
	[OS] = LAYOUT_4x12_enc(
