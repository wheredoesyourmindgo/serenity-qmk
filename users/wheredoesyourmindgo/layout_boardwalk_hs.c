...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_Z, KC_L, KC_M, KC_F, KC_Q, KC_LBRC, KC_RBRC, KC_X, KC_W, KC_O, KC_U, KC_SCLN, KC_BSPC,
        LT(LOWEST, KC_MINS), KC_S, KC_R, KC_T, KC_N, KC_P, KC_HOME, KC_PGUP, KC_Y, KC_D, KC_E, KC_I, KC_A, KC_EQL,
