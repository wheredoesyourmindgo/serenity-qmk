...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
    #if defined MISCREANTY_LAYOUT
        KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
        KC_DEL, KC_F, KC_L, KC_H, KC_K, KC_Q, KC_LBRC, KC_RBRC, KC_Z, KC_W, KC_O, KC_U, KC_MINS, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_M, KC_HOME, KC_PGUP, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_X, KC_J, KC_B, KC_D, KC_V, KC_END, KC_PGDN, KC_G, KC_P, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
        ...
        KC_QUOT, KC_A, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_M, KC_N, KC_E, KC_I, KC_O, KC_MINS,
    ...
    [BASE_QWRTY] = LAYOUT_boardwalk_hs(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_END, KC_PGDN, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, KC_RSFT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGHER), KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO,
        KC_LSFT, LT(LOWER_ALT,TGL_LOWER), OSM(MOD_RALT), KC_NO, VOID, DF(LOWER), KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, CAPS_SENTENCE,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH),KC_NO, KC_NO,   KC_PIPE,   KC_LABK, KC_LCBR,  KC_RCBR, KC_RABK, KC_EQL,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW),KC_NO, KC_NO,            KC_BSLASH, KC_SLSH, KC_LBRC,  KC_RBRC, KC_QUES, KC_RSFT,
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN5, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
	...
	[HIGHER] = LAYOUT_boardwalk_hs(
        ...
        TD(TD_MULTI_RSTR), TLNG_ILFT, TLNG_LFT,  TLNG_RGHT, TLNG_IRGHT, TD(TD_MULTI_MAX), KC_NO, KC_NO, OSL(LOWER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        KC_CAPS, UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, DF(HIGHER), VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, LT(LOWER, KC_ESC), KC_ENT, KC_TAB, DF(BASE), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HIGH] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, KC_NO, KC_VOLD, KC_VOLU, KC_MUTE, KC_NO, KC_NO, KC_NO, OSL(LOW), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DEBUG,
        KC_LSFT, KC_NO, KC_MRWD, KC_MFFD, KC_MPLY, TGL_LYT, KC_NO, KC_NO, DF(HIGH), VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
	...
	[HIGHEST] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_NO, KC_NO, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
