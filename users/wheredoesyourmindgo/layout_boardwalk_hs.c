...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_MINS, KC_S, KC_R, KC_T, KC_N, KC_F, KC_HOME, KC_PGUP, KC_G, KC_Y, KC_E, KC_I, KC_A, KC_SLSH,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_NO, KC_NO, KC_GRV, KC_EQL, KC_PIPE, KC_LCBR, KC_RCBR,  KC_NO,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW), KC_NO, KC_NO, KC_TILD, KC_PLUS, KC_BSLS, KC_LBRC, KC_RBRC,  KC_RSFT,
