...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHEST] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, TD(TD_F6_F16), TD(TD_F7_F17), TD(TD_F8_F18), TD(TD_F9_F19), TD(TD_F10_F20), KC_NO, KC_NO, DF(HIGHEST), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_LSFT, TD(TD_F11_F21), TD(TD_F12_F22), TD(TD_F13_F23), TD(TD_F14_F24), KC_F15, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
