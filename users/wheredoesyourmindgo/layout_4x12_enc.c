...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        ...
        KC_LSFT, KC_Z, KC_J, KC_V, KC_D, KC_Q, KC_B, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOW] = LAYOUT_4x12_enc(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_MINS, KC_SCOLON,  KC_EQL,  KC_LCBR, KC_RCBR, KC_QUOT,
        KC_LSFT, KC_LT, KC_GT, KC_DQUO, KC_COLN, KC_PLUS,                      KC_UNDS, KC_COLON, KC_PLUS, KC_LBRC, KC_RBRC, KC_CAPS,
