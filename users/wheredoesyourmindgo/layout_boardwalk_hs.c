...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_F, KC_L, KC_H, KC_K, KC_Q, KC_LBRC, KC_RBRC, KC_G, KC_P, KC_O, KC_U, KC_MINS, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_M, KC_HOME, KC_PGUP, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_X, KC_J, KC_B, KC_D, KC_V, KC_END, KC_PGDN, KC_QUOT, KC_W, KC_Z, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        KC_GRV, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGHER), KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_EQL,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_TILD, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH),KC_NO, KC_NO, KC_PIPE,   KC_LABK, KC_LCBR,  KC_RCBR, KC_RABK, KC_PLUS,
