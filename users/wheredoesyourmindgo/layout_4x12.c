...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [HIGH] = LAYOUT_4x12(
        ...
        KC_LSFT ,  MAC_MSTP, KC_MRWD,  KC_MFFD,  KC_MPLY,  KC_NO,  KC_NO, VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
	...
	[OS] = LAYOUT_4x12(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,    OS_SCRN_SHT_OPT,  OS_LNCHPD, OS_SPTLGHT,     OS_SIRI,            OS_SDBR,        OS_DSKTP,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   PRV_APP,        OS_PRV_SPC,     CMD_TAB_PRV,        CMD_TAB_NXT,        OS_NXT_SPC,     OS_FLLSCRN,
        KC_NO, KC_NO, KC_NO, KC_NO, VOID, KC_NO, KC_NO, OS_PRVS_APP_WNDW, OS_MSN_CNTRL, OS_APP_WNDWS,   OS_NXT_APP_WNDW,       KC_NO,
