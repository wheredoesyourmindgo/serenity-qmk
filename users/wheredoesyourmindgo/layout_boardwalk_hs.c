...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_X, KC_L, KC_D, KC_W, KC_Z, KC_LBRC, KC_RBRC, KC_K, KC_P, KC_O, KC_U, KC_SCLN, KC_BSPC,
        LT(LOWEST, KC_MINS), KC_N, KC_R, KC_T, KC_S, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_Q, KC_J, KC_M, KC_C, KC_V, KC_END, KC_PGDN, KC_B, KC_F, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
