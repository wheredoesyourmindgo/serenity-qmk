...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[OS] = LAYOUT_4x12(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, PRV_APP, CMD_TAB_PRV,  OS_PRVS_APP_WNDW, OS_NXT_APP_WNDW, CMD_TAB_NXT, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, VOID, KC_NO,  OS_DSKTP, OS_PRV_SPC,  OS_MSN_CNTRL,  OS_APP_WNDWS, OS_NXT_SPC, KC_NO,
