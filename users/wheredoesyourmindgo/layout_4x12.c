...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_4x12(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
    ...
    [LOWEST] = LAYOUT_4x12(
        ...
        KC_GRV, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LLOCK, KC_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
