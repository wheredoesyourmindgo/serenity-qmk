...
#if defined ENCODER_ENABLE && defined LOWER_LEFT_ENCODER
#define GRV_OR_LWST LT(LOWEST, KC_GRAVE)
#define LWST_OR_ENC ENC_BTN
#define NO_OR_ENC ENC_BTN
#else
#define GRV_OR_LWST KC_GRV
#define LWST_OR_ENC TD(TD_OOPSY)
#define NO_OR_ENC KC_NO
#endif

enum layers { BASE, QWRTY, LOWER, LOW, LOWEST, HIGHER, HIGH, HIGHEST, OS };

enum custom_keycodes { CMD_TAB_PRV = SAFE_RANGE, CAPS_SENTENCE, TGL_LYT, CMD_TAB_NXT, DISP_FDIM, DISP_FBRI, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, XOSM_RSFT, XOSM_RGUI, XOSM_RALT, XOSM_RCTL, WNDW_FSCRN, TLNG_LFT, TLNG_RGHT, TLNG_ILFT, TLNG_IRGHT, ENC_BTN, XWNDW_MAX, WNDW_LFT, WNDW_RGHT, WNDW_ILFT, WNDW_IRGHT, OS_BSPC, OS_DEL, OS_BCK_FWD, LLOCK, JIGGLE_MOUSE};
