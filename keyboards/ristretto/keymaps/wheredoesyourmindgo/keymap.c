...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[AUX] = LAYOUT(
        KC_DEL, OS_PRV_TAB, OS_PRV_APP_WNDW, OS_NXT_APP_WNDW, OS_NXT_TAB,  TD(TD_TGL_SEL), KC_APP, KC_PSCR, KC_SCRL, KC_PAUS, KC_INS, KC_BSPC,
        KC_MINS, KC_NO, TLNG_LFT, TLNG_RGHT, TD(TD_MULTI_RSTR), TD(TD_MULTI_MAX), LLOCK, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_QUOT,
        KC_LSFT, UNDO, CUT, COPY, PASTE, REDO, TGL_LYT, KC_CAPS, KC_NO, KC_NO, KC_NO, KC_RSFT,
    ...
    [HRDWR] = LAYOUT(
        OS_DEL, KC_NO, DISP_DIM, DISP_BRI, OS_DRKMD_TGL, KC_NO, KC_NO, KC_NO, KC_NO, DB_TOGG, QK_BOOT, KC_BSPC,
        KC_MINS, KC_NO, KC_VOLD, KC_VOLU, KC_MUTE, KC_NO, LLOCK, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_QUOT,
        KC_LSFT, KC_NO, KC_MRWD, KC_MFFD, KC_MPLY, KC_NO, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_RSFT,
	...
	[OS] = LAYOUT(
        OS_DEL, KC_NO, KC_NO, OS_TRM_VSR, KC_NO, KC_NO, OS_SCRN_SHT_OPT, OS_LNCHPD, OS_SPTLGHT, OS_SIRI, OS_SDBR, OS_BSPC,
