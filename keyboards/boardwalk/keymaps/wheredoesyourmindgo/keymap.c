...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        MT(MOD_LCTL,KC_ESC), KC_N, KC_R, KC_T, KC_S, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_X, KC_Z, KC_M, KC_C, KC_B, KC_END, KC_PGDN, KC_K, KC_P, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
	...
	[NUMNAV] = LAYOUT_ortho_2x2u(
        ...
        KC_ESC, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, TGL_SELECT_LP, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
	...
	[FUNC] = LAYOUT_ortho_2x2u(
        ...
        KC_ESC, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_NO, KC_NO, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_QUOT,
    ...
    [MOUSE] = LAYOUT_ortho_2x2u(
        ...
        KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LLOCK, KC_NO, KC_NO, QK_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_QUOT,
