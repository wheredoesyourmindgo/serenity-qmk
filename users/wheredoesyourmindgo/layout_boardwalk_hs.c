...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        KC_GRV, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, DF(LOWER), KC_NO, KC_NO, KC_DOT, KC_UP, KC_LEFT, KC_RGHT, KC_PGUP, KC_EQL,
        KC_NO, UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, TD(TD_PEMDAS), KC_DOWN, KC_HOME, KC_END, KC_PGDN, CAPS_SENTENCE,
