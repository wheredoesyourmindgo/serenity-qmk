...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_4x12(
        ...
        KC_GRV, OS_PRVS_WNDW, WNDW_SMLLR, WNDW_LRGR, OS_NXT_WNDW, WNDW_MAX, DF(HIGHER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        LSFT_T(KC_CAPS), WNDW_LFT_HLF, WNDW_BTTM_HLF, WNDW_TOP_HLF, WNDW_RGHT_HLF, XWNDW_CNTR, KC_NO, VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
	...
	[OS] = LAYOUT_4x12(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, VOID, KC_NO, PRV_APP, CMD_TAB_PRV, OS_DOCK, OS_EXPOSE, CMD_TAB_NXT, KC_NO,
