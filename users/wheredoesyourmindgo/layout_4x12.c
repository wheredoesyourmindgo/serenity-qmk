...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOW] = LAYOUT_4x12(
        KC_DEL, KC_EXLM      , KC_AT        , KC_HASH      , KC_DLR       , KC_PERC ,                  KC_CIRC, KC_AMPR, KC_LPRN, KC_RPRN, KC_ASTR, LGUI(KC_BSPC),
    ...
    [LOWEST] = LAYOUT_4x12(
        KC_DEL, KC_NO, KC_BTN2, KC_BTN3, KC_BTN1, KC_NO, KC_NO, KC_BTN1, KC_BTN3, KC_BTN2, KC_NO, KC_BSPC,
	...
	[HIGHER] = LAYOUT_4x12(
        LALT(KC_DEL), APP1, APP2, APP3, APP4, TD(TD_TGL_SEL), KC_NO, APP5, APP6, APP7, APP8, KC_BSPC,
    ...
    [HIGH] = LAYOUT_4x12(
        LCTL(KC_K),  DISP_FDIM, DISP_DIM , DISP_BRI,   DISP_FBRI, KC_NO,  RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI,   RESET,
