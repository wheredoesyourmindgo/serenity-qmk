...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_X, KC_Y, KC_C, KC_W, KC_B, KC_LBRC, KC_RBRC, KC_J, KC_L, KC_U, KC_SCLN, KC_Z, KC_BSPC,
        KC_QUOT, KC_R, KC_I, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP,  KC_M, KC_N, KC_E, KC_A, KC_O, KC_MINS,
        TD(TD_CAPS_WORD), KC_K, KC_Q, KC_F, KC_D, KC_P, KC_END, KC_PGDN, KC_V, KC_H, KC_SLSH, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
