...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[OS] = LAYOUT(
        ...
        KC_LSFT, KC_NO, OS_LP_SCRN_SHT_SLCT, OS_LP_SCRN_SHT_FULL, OS_SCRN_SHT_OPT, KC_NO, KC_NO, KC_NO, LGUI(KC_Q), LGUI(KC_H), KC_NO, KC_ENT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_NO, KC_SPC, ENC_BTN, KC_SPC, KC_NO, KC_NO, KC_RGUI, KC_RALT, KC_RCTL
    ),
    [MOUSE] = LAYOUT(
        ...
        KC_LSFT, UNDO, CUT, COPY, PASTE, REDO, SHAKE_MOUSE, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_ENT,
