...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), TD(TD_OOPS), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(FUNCXTR,KC_RIGHT)
    ),
    [QWRTY] = LAYOUT(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), TD(TD_OOPS), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), LT(FUNCXTR, KC_SLSH), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	[NUMNAV] = LAYOUT(
	...
	[FUNC] = LAYOUT(
        ...
        TD(TD_OOPS), KC_RCTL, XOSM_RALT, KC_RGUI, KC_ESC, KC_ENT, KC_NO, KC_SPC, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_NO
    ),
	[FUNCXTR] = LAYOUT(
