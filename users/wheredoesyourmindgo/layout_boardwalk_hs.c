...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_NO, KC_NO, KC_GRV, KC_EQL, KC_BSLS, KC_LCBR, KC_RCBR,  KC_NO,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW), KC_NO, KC_NO, KC_TILD, KC_PLUS, KC_PIPE, KC_LBRC, KC_RBRC,  KC_RSFT,
