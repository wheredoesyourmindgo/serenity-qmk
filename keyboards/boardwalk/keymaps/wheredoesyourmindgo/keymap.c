...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        KC_MUTE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_EQL, KC_BSLS, KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL,
        KC_TAB, KC_Q, KC_L, KC_D, KC_W, KC_V, KC_LBRC, KC_RBRC, KC_J, KC_F, KC_O, KC_U, KC_SCLN, KC_BSPC,
        LT(MOUSE,KC_ESC), KC_N, KC_R, KC_T, KC_S, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_QUOT,
