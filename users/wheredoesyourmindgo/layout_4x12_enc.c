...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER_ALT] = LAYOUT_4x12_enc(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DF(BASE), KC_TRNS   , ENC_BTN, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
	[LOW] = LAYOUT_4x12_enc(
    ...
    [LOWEST] = LAYOUT_4x12_enc(
        KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN1, KC_BTN3, KC_BTN2, KC_LOCK, KC_BSPC,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, DF(LOWEST), KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, KC_NO, KC_NO, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_RSFT,
        DF(BASE), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, KC_NO, ENC_BTN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),
	[HIGHER] = LAYOUT_4x12_enc(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, TD(TD_LOWER_ESC), KC_ENT, ENC_BTN, KC_TAB, DF(BASE), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HIGH] = LAYOUT_4x12_enc(
        KC_DEL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_BSPC,
        KC_GRV, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, DF(HIGH), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
	...
	[HIGHEST] = LAYOUT_4x12_enc(
        RESET, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO, KC_NO , KC_NO,  KC_NO, KC_NO, KC_NO,
        DEBUG, KC_NO, KC_NO, KC_NO, KC_NO, DF(HIGHEST), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, TGL_LYT, KC_NO, VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, ENC_BTN, KC_NO, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DF(BASE)
    ),
	[OS] = LAYOUT_4x12_enc(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, DF(BASE), DF(BASE), ENC_BTN, OS_TRM_VSR, OS_LNCHR, KC_NO, KC_NO, KC_NO, KC_NO
    )
