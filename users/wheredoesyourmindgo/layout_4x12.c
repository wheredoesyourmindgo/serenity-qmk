...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_4x12(
        LALT(KC_DEL), OS_PRV_TAB, KC_NO, KC_NO, OS_NXT_TAB, WNDW_RSTR, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSPC,
        KC_GRV, OS_PRVS_WNDW, WNDW_SMLLR, WNDW_LRGR, OS_NXT_WNDW, WNDW_MAX, DF(HIGHER), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
