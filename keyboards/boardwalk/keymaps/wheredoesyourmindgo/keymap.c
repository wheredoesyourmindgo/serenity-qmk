...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE,KC_MUTE), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(FUNCXTR,KC_RIGHT)
    ),
    [QWRTY] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE,KC_MUTE), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), LT(FUNCXTR, KC_SLSH), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	...
	[SYMBL] = LAYOUT_ortho_2x2u(
        ...
        KC_MINS, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_GRV, KC_BSLS, KC_EQL,  KC_LCBR, KC_RCBR, KC_QUOT,
        KC_LSFT, KC_LT, KC_GT, KC_DQUO, KC_COLN, KC_PLUS, KC_NO, KC_NO, KC_TILD, KC_PIPE, KC_PLUS, KC_LBRC, KC_RBRC, KC_RSFT,
        LT(MOUSE,KC_MUTE), KC_NO, KC_NO, KC_NO, LT(NUMNAV,KC_ESC), KC_ENT, KC_SPC, KC_TAB, KC_NO,  XOSM_RALT, KC_NO, KC_NO
    ),
    [MOUSE] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE,KC_MUTE), KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, KC_SPC, KC_TAB, KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[AUX] = LAYOUT_ortho_2x2u(
        ...
        KC_MINS, WNDW_LP_MAX, WNDW_LP_SMLR, WNDW_LP_LGR, WNDW_LP_CNTR, WNDW_LP_RST, KC_NO, KC_NO, LLOCK, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_QUOT,
        KC_LSFT, UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, KC_CAPS, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_RSFT,
    ...
    [HRDWR] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE,KC_MUTE), KC_NO, XOSM_RALT, KC_NO, KC_ESC, KC_ENT, KC_SPC, KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO
    ),
	[FUNC] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE,KC_MUTE), KC_RCTL, XOSM_RALT, KC_RGUI, KC_ESC, KC_ENT, KC_SPC, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_NO
    ),
	...
	[OS] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, OS_FLLSCRN, OS_PRV_SPC, OS_NXT_SPC, OS_MSN_CNTRL, OS_DSKTP, KC_NO, KC_NO, OS_DOCK, OS_EXPOSE, CMD_TAB_PRV, CMD_TAB_NXT, PRV_APP, KC_NO,
