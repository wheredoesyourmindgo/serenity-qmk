...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_4x12(
        LALT(KC_DEL), KC_NO, WNDW_SMLLR, WNDW_LRGR, WNDW_RSTR, TD(TD_TGL_SEL), KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSPC,
	...
	[OS] = LAYOUT_4x12(
        CMD_TAB_HIDE, KC_NO, KC_NO, KC_NO, KC_NO, OS_SCRN_SHT_OPT, OS_SPTLGHT, OS_LNCHPD, OS_SIRI, OS_SDBR, KC_NO, CMD_TAB_QUIT,
