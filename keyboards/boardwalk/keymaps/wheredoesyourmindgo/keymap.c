...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, MO(LOWEST), MO(LOWER), LT(LOW,KC_SPC), /* <-2U  2U-> */ LT(HIGH,KC_ENT), MO(HIGHER), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, MO(LOWEST), MO(LOWER), LT(LOW,KC_SPC), /* <-2U  2U-> */ LT(HIGH,KC_ENT), MO(HIGHER_HRM), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
