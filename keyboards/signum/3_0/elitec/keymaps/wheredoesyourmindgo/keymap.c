...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_ortho_4x12(
        ...
        KC_NO , XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, DF(LOWER),         KC_DEL, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_BSPC,
	...
	[HIGHER] = LAYOUT_ortho_4x12(
        ...
        KC_NO, TO(BASE_HRM), KC_CAPS, KC_LEAD, OSHR, KC_APP, DF(HIGHER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
	...
	[HIGHER_HRM] = LAYOUT_ortho_4x12(
        LALT(KC_DEL), APP4, APP3, APP1, APP2, TD(TD_TGL_SEL), KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_NO,
        KC_NO, TO(BASE), KC_CAPS, KC_LEAD, OSHR, KC_APP, DF(HIGHER_HRM), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        KC_LSFT, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), SGUI(KC_Z), KC_NO, VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
