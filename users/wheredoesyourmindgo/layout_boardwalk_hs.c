...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_X, KC_J, KC_H, KC_V, KC_Z, KC_LBRC, KC_RBRC, KC_Q, KC_W, KC_U, KC_O, KC_MINS, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_F, KC_HOME, KC_PGUP, KC_G, KC_D, KC_E, KC_A, KC_I, KC_EQL,
