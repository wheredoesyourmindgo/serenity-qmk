...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        KC_TRNS, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, DF(LOWER), KC_NO, KC_NO, KC_MINS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_EQL,
        KC_NO, UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, KC_DOT, KC_HOME, KC_PGDN, KC_PGUP, KC_END, CAPS_SENTENCE,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,            KC_BSLASH, KC_SLSH, KC_LBRC,  KC_RBRC, KC_QUES, KC_CAPS,
    ...
    [HIGH] = LAYOUT_boardwalk_hs(
        ...
        KC_CAPS, KC_NO, KC_MRWD, KC_MFFD, KC_MPLY, TGL_LYT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
