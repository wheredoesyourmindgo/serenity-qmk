...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_60_ansi(
        ...
        KC_TAB, KC_Q, KC_L, KC_G, KC_W, KC_V, KC_J, KC_F, KC_O, KC_U, KC_MINS, KC_EQL, KC_SLSH, KC_BSLS,
        LT(RAISE,KC_ESC), KC_R, KC_N, KC_T, KC_S, KC_P, KC_Y, KC_H, KC_E, KC_A, KC_I, KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z, KC_X, KC_M, KC_C, KC_B, KC_K, KC_D, KC_QUOT, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
