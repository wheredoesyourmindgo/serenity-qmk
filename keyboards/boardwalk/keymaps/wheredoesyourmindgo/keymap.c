...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), TD(TD_LOWER_ESC), TD(TD_LOW_ENT), /* <-2U  2U-> */ LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), TD(TD_LOWER_ESC), TD(TD_LOW_ENT), /* <-2U  2U-> */ LT(HIGH,KC_TAB), LT(HIGHER_HRM,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    ...
    [LOWEST] = LAYOUT_ortho_2x2u(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_BTN2, KC_BTN3, KC_BTN1, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN1, KC_BTN3, KC_BTN2, KC_NO, LGUI(KC_BSPC),
	...
	[HIGHER] = LAYOUT_ortho_2x2u(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        LALT(KC_DEL), APP4, APP3, APP1, APP2, TD(TD_TGL_SEL), KC_NO, KC_NO, KC_NO, APP6, APP5, APP7, APP8, KC_NO,
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, TD(TD_LOWER_ESC), KC_ENT, /* <-2U  2U-> */ KC_TAB, DF(BASE), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	[HIGHER_HRM] = LAYOUT_ortho_2x2u(
        ...
        LSFT_T(KC_CAPS), UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, TD(TD_LOWER_ESC), KC_ENT, /* <-2U  2U-> */ KC_TAB, DF(BASE_HRM), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	...
	[HIGHEST] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_NO, KC_NO,/* <-2U  2U-> */  KC_NO, KC_NO, DF(BASE), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
	[OS] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,     PRV_APP,       OS_PRV_SPC,     CMD_TAB_PRV,        CMD_TAB_NXT,        OS_NXT_SPC,     DF(WNDW),
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, DF(BASE), OS_QUIT, /* <-2U  2U-> */    OS_MIN,  OS_FLLSCRN,                   KC_NO,              KC_NO,              KC_NO,          KC_NO
    ),
