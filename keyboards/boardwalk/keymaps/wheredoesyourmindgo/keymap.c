...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_ortho_2x2u(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        LALT(KC_DEL), KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, TD(TD_TGL_SEL), KC_NO, OS_APP1, OS_APP2, OS_APP3, KC_NO, KC_NO, KC_NO, KC_NO,
	...
	[OS] = LAYOUT_ortho_2x2u(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,     KC_NO,            KC_NO,          KC_NO,              KC_NO,              KC_NO,          KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,     OS_SCRN_SHT_OPT,  OS_SPTLGHT,     OS_LNCHPD,          OS_SIRI,            OS_SDBR,        KC_NO,
