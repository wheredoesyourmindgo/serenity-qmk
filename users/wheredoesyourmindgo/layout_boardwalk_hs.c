...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        ...
        DF(BASE), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, KC_ENT, KC_SPC, KC_TAB, KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[HIGHER] = LAYOUT_boardwalk_hs(
        ...
        TD(TD_MULTI_RSTR), TLNG_LFT, TLNG_ILFT, TLNG_IRGHT, TLNG_RGHT, TD(TD_MULTI_MAX), KC_NO, KC_NO, DF(HIGHER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
