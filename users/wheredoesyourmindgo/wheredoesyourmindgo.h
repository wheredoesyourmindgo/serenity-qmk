...
// Remapping paste in Karabiner
// #define PASTE LGUI(KC_V)
#define PASTE LGUI(KC_D)
...
enum keycodes { CMD_TAB_PRV = SAFE_RANGE, CMD_TAB_NXT, OOPS, DISP_FDIM, DISP_FBRI, OSHR, VOL_JUP, XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, XOSM_RSFT, XOSM_RGUI, XOSM_RALT, XOSM_RCTL };
