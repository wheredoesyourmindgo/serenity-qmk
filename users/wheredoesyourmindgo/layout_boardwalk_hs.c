...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_Q, KC_L, KC_D, KC_W, KC_Z, KC_LBRC, KC_RBRC, KC_Y, KC_V, KC_O, KC_U, KC_SCLN, KC_BSPC,
        LT(LOWEST, KC_MINS), KC_N, KC_R, KC_T, KC_S, KC_G, KC_HOME, KC_PGUP, KC_P, KC_H, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_B, KC_J, KC_M, KC_C, KC_X, KC_END, KC_PGDN, KC_K, KC_F, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_MINS), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_EQL,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_MINS), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK,KC_NO, KC_NO,  KC_GRV,  KC_SLSH, KC_BSLS, KC_LCBR, KC_RCBR, KC_EQL,
        KC_LSFT, KC_LT, KC_GT, KC_DQUO, KC_COLN, KC_PLUS, KC_NO, KC_NO,                             KC_TILD, KC_QUES, KC_PIPE, KC_LBRC, KC_RBRC, KC_CAPS,
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        ...
        KC_MINS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, LLOCK,
    ...
    [HIGH] = LAYOUT_boardwalk_hs(
        ...
        KC_MINS, KC_NO, KC_VOLD, KC_VOLU, KC_MUTE, KC_NO, KC_NO, KC_NO, LLOCK, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, DEBUG,
