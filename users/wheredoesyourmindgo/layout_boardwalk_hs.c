...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_MINS), KC_M, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_N, KC_E, KC_I, KC_A, KC_QUOT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_MINS), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, TD(TD_DOTEQL), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
