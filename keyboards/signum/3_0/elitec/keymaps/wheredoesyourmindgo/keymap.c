...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_HRM] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_ESC), LT(LOW,KC_ENT), LT(HIGH,KC_TAB), LT(HIGHER_HRM,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
