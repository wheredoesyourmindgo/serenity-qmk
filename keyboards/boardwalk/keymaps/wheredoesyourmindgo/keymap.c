...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_ortho_2x2u(
        ...
        KC_GRV,  XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, DF(LOWER),         KC_NO, KC_NO, KC_SPC, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
	...
	[HIGHER] = LAYOUT_ortho_2x2u(
        ...
        LSFT_T(KC_CAPS), LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), SGUI(KC_Z), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
	...
	[WNDW] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, KC_NO, LCA(KC_J), WNDW_BTTM_HLF, LCA(KC_K), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, WNDW_ALMST_MAX, WNDW_VRT_MAX, KC_NO, KC_NO,
