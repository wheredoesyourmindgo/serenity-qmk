...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(FUNC2,KC_RIGHT)
    ),
    [QWRTY] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), LT(FUNC2, KC_SLSH), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	[NUMNAV] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, KC_ESC, KC_ENT, KC_SPC, LT(AUX,KC_TAB), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	...
	[AUX] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_NO, XOSM_RALT, KC_NO, LT(NUMNAV,KC_ESC), KC_ENT, KC_SPC, KC_TAB, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
