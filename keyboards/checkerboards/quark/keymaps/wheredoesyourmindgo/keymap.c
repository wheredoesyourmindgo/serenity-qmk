...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(FUNCXTR,KC_RIGHT)
    ),
    [QWRTY] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), LT(HRDWR,KC_SPC), LT(AUX,KC_TAB), LT(FUNCXTR, KC_SLSH), KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	[NUMNAV] = LAYOUT_ortho_4x12(
        KC_DEL , KC_1 , KC_2 , KC_3 , KC_4, KC_5, KC_6, KC_7, KC_8 , KC_9, KC_0, KC_BSPC,
        LT(MOUSE, KC_MINS), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, TD(TD_DOTEQL), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
        KC_LSFT, UNDO, CUT, COPY, PASTE, REDO, TD(TD_PEMDAS), KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_RSFT,
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, KC_ESC, LT(SYMBL,KC_ENT), KC_SPC, LT(AUX,KC_TAB), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[SYMBL] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_NO, KC_NO, KC_NO, LT(NUMNAV,KC_ESC), KC_ENT, KC_SPC, KC_TAB, KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [MOUSE] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, KC_SPC, KC_TAB, KC_RGUI, XOSM_RALT, KC_RCTL, KC_NO
    ),
	[AUX] = LAYOUT_ortho_4x12(
        ...
        TD(TD_OOPS), KC_NO, XOSM_RALT, KC_NO, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), KC_SPC, KC_TAB, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
