...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_X, KC_Y, KC_C, KC_W, KC_P, KC_LBRC, KC_RBRC, KC_J, KC_L, KC_U, KC_Q, KC_SCLN, KC_BSPC,
        KC_QUOT, KC_R, KC_I, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_M, KC_N, KC_E, KC_A, KC_O, KC_MINS,
        TD(TD_CAPS_WORD), KC_Z, KC_K, KC_F, KC_D, KC_B, KC_END, KC_PGDN, KC_V, KC_H, KC_SLSH, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
    ...
    #elif defined SERTAIN_LAYOUT
        KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
        KC_DEL, KC_X, KC_L, KC_D, KC_F, KC_V, KC_LBRC, KC_RBRC, KC_J, KC_W, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_T, KC_N, KC_K, KC_HOME, KC_PGUP, , KC_P, KC_C, KC_E, KC_I, KC_A, KC_MINS,
        TD(TD_CAPS_WORD), KC_Z, KC_Q, KC_M, KC_H, KC_B, KC_END, KC_PGDN, KC_G, KC_Y, KC_QUOT, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
        TD(TD_OOPSY), KC_LCTL, KC_LALT, KC_LGUI, TD(TD_LOWER_ESC), TD(TD_LOW_ENT), LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(HIGHEST,KC_RIGHT)
    #elif defined MISCREANTY_LAYOUT
        KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
        KC_DEL, KC_SLSH, KC_L, KC_H, KC_K, KC_Q, KC_LBRC, KC_RBRC, KC_Z, KC_P, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_F, KC_S, KC_R, KC_N, KC_T, KC_M, KC_HOME, KC_PGUP, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_MINS,
        TD(TD_CAPS_WORD), KC_X, KC_J, KC_B, KC_D, KC_V, KC_END, KC_PGDN, KC_G, KC_W, KC_QUOT, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
        TD(TD_OOPSY), KC_LCTL, KC_LALT, KC_LGUI, TD(TD_LOWER_ESC), TD(TD_LOW_ENT), LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(HIGHEST,KC_RIGHT)
    #else
        KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
    ...
    [BASE_QWRTY] = LAYOUT_boardwalk_hs(
        ...
        KC_QUOT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_HOME, KC_PGUP,  KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_MINS,
	...
	[LOW] = LAYOUT_boardwalk_hs(
            ...
            KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_NO, KC_NO, KC_PIPE, KC_SLSH, KC_EQL, KC_LCBR, KC_RCBR, KC_QUES,
            KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW), KC_NO, KC_NO, KC_NO, KC_BSLS, KC_PLUS, KC_LBRC, KC_RBRC,  KC_RSFT,
