...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12(
        KC_DEL, KC_Y, KC_L, KC_H, KC_V, KC_Z, KC_QUOT, KC_W, KC_O, KC_U, KC_EQL, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_F, KC_G, KC_D, KC_E, KC_I, KC_A, KC_MINS,
        KC_LSFT, KC_X, KC_J, KC_B, KC_M, KC_K, KC_P, KC_C, KC_Q, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOWER] = LAYOUT_4x12(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGHER), KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MINS,
	...
	[LOW] = LAYOUT_4x12(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_PIPE,  KC_LCBR, KC_LT, KC_GT, KC_RCBR, KC_UNDS,
