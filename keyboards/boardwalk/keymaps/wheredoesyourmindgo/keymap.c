...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        KC_TAB, KC_Q, KC_L, KC_C, KC_P, KC_B, KC_LBRC, KC_RBRC, KC_J, KC_F, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_ESC, KC_M, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_N, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_V, KC_X, KC_W, KC_D, KC_Z, KC_END, KC_PGDN, KC_K, KC_H, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
    ...
    [QWRTY] = LAYOUT_ortho_2x2u(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_END, KC_PGDN, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, RSFT_T(KC_ENT),
	...
	[SYMBL] = LAYOUT_ortho_2x2u(
        ...
        KC_ESC, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_BSLS, KC_MINS, KC_EQL,  KC_LCBR, KC_RCBR, KC_QUOT,
        KC_LSFT, KC_NO, KC_NO, KC_TILDE, KC_GRV, KC_NO, KC_NO, KC_NO, KC_PIPE, KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_ENT,
    ...
    [HRDWR] = LAYOUT_ortho_2x2u(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO , KC_NO, KC_NO , KC_NO, KC_NO,
        KC_TAB, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO, KC_NO, KC_NO, OS_DRKMD_TGL, DISP_DIM, DISP_BRI, KC_NO, KC_BSPC,
        KC_ESC, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU,  KC_NO,  KC_QUOT,
        KC_LSFT, QK_BOOT, DB_TOGG, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TGL_LYT, KC_MRWD, KC_MFFD, KC_MPLY, KC_NO, KC_ENT,
	...
	[OS] = LAYOUT_ortho_2x2u(
        ...
        KC_LSFT, OS_SCRN_SHT_CLP_SLCT, OS_SCRN_SHT_CLP, OS_SCRN_SHT_SLCT, OS_SCRN_SHT, OS_SCRN_SHT_OPT, KC_NO,KC_NO, KC_NO, KC_NO, LGUI(KC_Q), LGUI(KC_H), KC_NO, RSFT_T(KC_ENT),
        KC_NO, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    )
};
