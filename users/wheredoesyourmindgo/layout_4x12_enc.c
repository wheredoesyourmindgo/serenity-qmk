...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LOWEST] = LAYOUT_4x12_enc(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LOCK, KC_MS_U, KC_MS_L, KC_MS_R, KC_WH_D, DF(LOWEST),
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_D, KC_WH_R, KC_WH_L, KC_WH_U, KC_RSFT,
        DF(BASE), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, KC_ENT, ENC_BTN, KC_TAB, KC_SPC, KC_RGUI, XOSM_RALT, KC_RCTL, KC_NO
    #else
        OS_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN5, KC_BTN1, KC_BTN2, KC_BTN3, KC_BTN4, OS_BSPC,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_U, KC_MS_L, KC_MS_R, KC_WH_D, DF(LOWEST),
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_D, KC_WH_R, KC_WH_L, KC_WH_U, KC_RSFT,
        DF(BASE), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, KC_ENT, ENC_BTN, KC_TAB, KC_SPC, KC_RGUI, XOSM_RALT, KC_RCTL, KC_NO
    #endif
    ),
