...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        ...
        KC_DEL, KC_SLSH, KC_Y, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Q, KC_SCLN, KC_BSPC,
        KC_MINS, KC_R, KC_I, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_A, KC_O, KC_QUOT,
        TD(TD_CAPS_WORD), KC_W, KC_X, KC_C, KC_D, KC_K, KC_V, KC_H, KC_COMM, KC_DOT, KC_Z, TD(TD_CAPS_SENTENCE),
	...
	[LOWER] = LAYOUT_4x12_enc(
        ...
        KC_MINS, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGHER), KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
	...
	[LOW] = LAYOUT_4x12_enc(
        ...
        KC_MINS, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_GRV , KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, KC_QUOT,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW), KC_TILD, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, DF(BASE), ENC_BTN, KC_TAB, KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO
    ),
    [LOWEST] = LAYOUT_4x12_enc(
        KC_DEL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, BTN1_HOLD, KC_BTN1, KC_BTN3, KC_BTN2, KC_NO, KC_BSPC,
	...
	[HIGHER] = LAYOUT_4x12_enc(
        ...
        TD(TD_MULTI_RSTR),  TLNG_LFT, TLNG_ILFT,  TLNG_IRGHT, TLNG_RGHT, TD(TD_MULTI_MAX), OSL(LOWER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
    ...
    [HIGH] = LAYOUT_4x12_enc(
        ...
        KC_MINS, KC_NO, KC_VOLD, KC_VOLU, KC_NO, KC_MUTE, OSL(LOW), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DEBUG,
        KC_LSFT, KC_MRWD, MAC_MSTP, KC_MPLY, KC_MFFD, TGL_LYT, DF(HIGH), VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
	...
	[OS] = LAYOUT_4x12_enc(
        KC_NO, KC_NO, KC_NO, OS_TRM_VSR, OS_LNCHR, KC_NO, OS_SCRN_SHT_OPT, OS_SPTLGHT, OS_LNCHPD, OS_SIRI, OS_SDBR, CMD_TAB_QUIT,
        PRV_APP, CMD_TAB_PRV, OS_EXPOSE, OS_MSN_CNTRL, CMD_TAB_NXT, OS_FLLSCRN, OS_DSKTP, OS_PRV_SPC, OS_SPC1, OS_LAST_SPC, OS_NXT_SPC, KC_NO,
