...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        KC_TAB, KC_X, KC_L, KC_D, KC_P, KC_G, KC_LBRC, KC_RBRC, KC_Z, KC_K, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_ESC, KC_N, KC_R, KC_T, KC_S, KC_W, KC_HOME, KC_PGUP, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_Q, KC_J, KC_M, KC_C, KC_V, KC_END, KC_PGDN, KC_B, KC_F, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
