...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_SPC), LT(LOW,KC_TAB), /* <-2U  2U-> */ LT(HIGH,KC_ENT), LT(HIGHER,KC_ESC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_SPC), LT(LOW,KC_TAB), /* <-2U  2U-> */ LT(HIGH,KC_ENT), LT(HIGHER_HRM,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    ...
    [LOWEST] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_NO, DF(BASE), KC_NO, /* <-2U  2U-> */ KC_NO, KC_NO, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	[HIGHER] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LT(LOWER,KC_SPC), KC_ENT, /* <-2U  2U-> */ KC_TAB, DF(BASE), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	[HIGHER_HRM] = LAYOUT_ortho_2x2u(
        ...
        LSFT_T(KC_CAPS), LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), SGUI(KC_Z), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LT(LOWER,KC_SPC), KC_ENT, /* <-2U  2U-> */ KC_TAB, DF(BASE_HRM), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
