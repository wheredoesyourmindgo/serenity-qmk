...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_4x12_enc(
        ...
        KC_LSFT, MO(LOWER_ALT), OSM(MOD_RALT)      , KC_NO        , VOID        , KC_NO    ,          KC_NO  , KC_HOME, KC_PGDN, KC_PGUP, KC_END, RSFT_T(KC_CAPS),
    ...
    [HIGH] = LAYOUT_4x12_enc(
        KC_DEL, KC_NO, DISP_DIM, DISP_BRI, KC_NO, OS_DRKMD_TGL, RGB_TOG, RGB_MOD, RGB_VAI, RGB_HUI, RGB_SAI, RESET,
