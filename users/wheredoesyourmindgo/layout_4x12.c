...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12(
        ...
        TD(TD_OS_GRV_OSHR), ALPH_R2C1, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, ALPH_R2C10, KC_QUOT,
    ...
    [BASE_HRM] = LAYOUT_4x12(
        KC_DEL, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_BSPC,
        TD(TD_OS_GRV_OSHR), LCTL_T(ALPH_R2C1), LALT_T(KC_R), LGUI_T(KC_S), LSFT_T(KC_T), KC_G, KC_M, RSFT_T(KC_N), RGUI_T(KC_E), RALT_T(KC_I), RCTL_T(ALPH_R2C10), KC_QUOT,
