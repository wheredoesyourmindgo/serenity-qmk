...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LOCK, KC_MS_U, KC_MS_L, KC_MS_R, KC_WH_D, DF(LOWEST),
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_D, KC_WH_R, KC_WH_L, KC_WH_U, KC_RSFT,
