...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_F, KC_L, KC_H, KC_K, KC_Q, KC_LBRC, KC_RBRC, KC_G, KC_P, KC_O, KC_U, KC_EQL, KC_BSPC,
        KC_Z, KC_S, KC_R, KC_N, KC_T, KC_M, KC_HOME, KC_PGUP, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_MINS,
        KC_LSFT, KC_X, KC_J, KC_B, KC_D, KC_V, KC_END, KC_PGDN, KC_QUOT, KC_W, KC_GRV, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        KC_GRV, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGHER), KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MINS,
        KC_LSFT, LT(LOWER_ALT,TGL_LOWER), OSM(MOD_RALT), KC_NO, KC_NO, DF(LOWER), KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, CAPS_SENTENCE,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_TILD, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH),KC_NO, KC_NO, KC_PIPE,   KC_LCBR, KC_LT, KC_GT, KC_RCBR, KC_UNDS,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, KC_NO, DF(LOW),KC_NO, KC_NO,            KC_BSLASH, KC_SLSH, KC_LBRC,  KC_RBRC, KC_QUES, KC_RSFT,
	...
	[HIGHER] = LAYOUT_boardwalk_hs(
        ...
        KC_CAPS, UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, DF(HIGHER), KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
    ...
    [HIGH] = LAYOUT_boardwalk_hs(
        ...
        KC_LSFT, KC_NO, KC_MRWD, KC_MFFD, KC_MPLY, TGL_LYT, KC_NO, KC_NO, DF(HIGH), KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
