...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
        KC_DEL, KC_Z, KC_L, KC_H, KC_M, KC_Q, KC_LBRC, KC_RBRC, KC_P, KC_F, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_K, KC_HOME, KC_PGUP, KC_Y, KC_C, KC_E, KC_I, KC_A, KC_MINS,
