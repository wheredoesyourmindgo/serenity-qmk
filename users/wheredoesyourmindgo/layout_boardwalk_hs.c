...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_W, KC_L, KC_Y, KC_P, KC_K, KC_LBRC, KC_RBRC, KC_X, KC_F, KC_O, KC_U, KC_BSLS, KC_BSPC,
        LT(LOWEST, KC_GRV), KC_C, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_M, KC_N, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_Q, KC_J, KC_V, KC_D, KC_Z, KC_END, KC_PGDN, KC_B, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_RSFT,
    ...
    [QWRTY] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_GRV), KC_A, KC_S, KC_D, KC_F, KC_G, KC_HOME, KC_PGUP, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, KC_MINS, KC_COLON,  KC_EQL,  KC_LCBR, KC_RCBR, KC_QUOT,
        KC_LSFT, KC_LT, KC_GT, KC_DQUO, KC_COLN, KC_PLUS, KC_NO, KC_NO,                      KC_UNDS, KC_SCOLON, KC_PLUS, KC_LBRC, KC_RBRC, KC_CAPS,
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        ...
        KC_GRV, KC_NO, KC_NO, KC_NO, KC_NO, LLOCK, KC_NO, KC_NO, KC_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, SHAKE_MOUSE, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_RSFT,
        TD(TD_OOPS), KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_ENT, KC_SPC, KC_TAB, KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[HIGHER] = LAYOUT_boardwalk_hs(
        ...
        TD(TD_MULTI_RSTR), TLNG_LFT, TLNG_ILFT, TLNG_IRGHT, TLNG_RGHT, TD(TD_MULTI_MAX), KC_NO, KC_NO, LLOCK, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_NO,
    ...
    [HIGH] = LAYOUT_boardwalk_hs(
        ...
        KC_GRV, KC_NO, KC_VOLD, KC_VOLU, KC_MUTE, KC_NO, KC_NO, KC_NO, LLOCK, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, DEBUG,
	...
	[HIGHEST] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO, KC_NO, LLOCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
