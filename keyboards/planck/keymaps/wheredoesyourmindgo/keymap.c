...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_planck_grid(
        ...
        TD(TD_LCTL), TD(TD_LALT), TD(TD_LGUI), MO(LOWEST), MO(LOWER), LT(LOW,KC_SPC), LT(HIGH,KC_ENT), MO(HIGHER), LT(HIGHEST,KC_LEFT), TD(TD_RGUI), TD(TD_RALT), TD(TD_RCTL)
    ),
    [BASE_HRM] = LAYOUT_planck_grid(
        ...
        TD(TD_LCTL), TD(TD_LALT), TD(TD_LGUI), MO(LOWEST), MO(LOWER), LT(LOW,KC_SPC), LT(HIGH,KC_ENT), MO(HIGHER_HRM), LT(HIGHEST,KC_LEFT), TD(TD_RGUI), TD(TD_RALT), TD(TD_RCTL)
    ),
