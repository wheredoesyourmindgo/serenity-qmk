...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[SYMBL] = LAYOUT(
        ...
        LT(MOUSE,KC_MUTE), KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), KC_SPC, KC_SPC, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[AUX] = LAYOUT(
        ...
        LT(MOUSE,KC_MUTE), KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), KC_SPC, LT(HRDWR,KC_SPC), MO(SYMBL), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [HRDWR] = LAYOUT(
        ...
        LT(MOUSE,KC_MUTE), KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), LT(AUX,KC_SPC), KC_SPC, MO(SYMBL), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[FUNC] = LAYOUT(
