...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOW] = LAYOUT_4x12(
        ...
        #else
            KC_DEL, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
            KC_BSLS, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_NO, KC_GRV, KC_EQL,  KC_LCBR, KC_RCBR, KC_PIPE,
            KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW),          KC_NO, KC_TILD, KC_PLUS, KC_LBRC, KC_RBRC, KC_RSFT,
            KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, DF(BASE), KC_TAB, KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO
        #endif
    ),
    [LOWEST] = LAYOUT_4x12(
