...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        KC_TAB, KC_Q, KC_L, KC_W, KC_P, KC_B, KC_LBRC, KC_RBRC, KC_J, KC_F, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_ESC, KC_M, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_N, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_END, KC_PGDN, KC_K, KC_H, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
