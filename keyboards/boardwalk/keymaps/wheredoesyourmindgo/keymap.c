...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWRTY] = LAYOUT_ortho_2x2u(
        LT(MOUSE,KC_MUTE), KC_1, KC_2, KC_3, KC_4, KC_5, KC_EQL, KC_BSLS, KC_6, KC_7, KC_8, KC_9, KC_0, KC_NO,
	...
	[NUMNAV] = LAYOUT_ortho_2x2u(
        LT(MOUSE,KC_MUTE), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	...
	[SYMBL] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, MO(NUMNAV), KC_SPC, KC_SPC, KC_NO, KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [AUX] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), KC_SPC, LT(HRDWR,KC_SPC), MO(SYMBL), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HRDWR] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), LT(AUX,KC_SPC), KC_SPC, MO(SYMBL), KC_NO, KC_NO, KC_NO, KC_NO
    ),
    ...
    [MOUSE] = LAYOUT_ortho_2x2u(
        LLOCK, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
