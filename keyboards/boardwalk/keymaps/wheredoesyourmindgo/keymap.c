...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[OS] = LAYOUT_ortho_2x2u(
        ...
        DF(BASE), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,     PRV_APP,       OS_PRV_SPC,     CMD_TAB_PRV,        CMD_TAB_NXT,        OS_NXT_SPC,     OS_FLLSCRN,
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, DF(BASE), KC_NO, /* <-2U  2U-> */   DF(WNDW),           KC_NO,          KC_NO,              KC_NO,              KC_NO,          KC_NO
    ),
