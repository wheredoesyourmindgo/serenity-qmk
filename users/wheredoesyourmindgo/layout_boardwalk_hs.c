...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_Q, KC_L, KC_D, KC_W, KC_Z, KC_LBRC, KC_RBRC, KC_B, KC_F, KC_O, KC_U, KC_SCLN, KC_BSPC,
        LT(LOWEST, KC_MINS), KC_N, KC_R, KC_T, KC_S, KC_G, KC_HOME, KC_PGUP, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_X, KC_J, KC_M, KC_C, KC_V, KC_END, KC_PGDN, KC_K, KC_P, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
    ...
    [LOWEST] = LAYOUT_boardwalk_hs(
        ...
        KC_MINS, KC_NO, KC_NO, KC_NO, KC_NO, LLOCK, KC_NO, KC_NO, KC_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
