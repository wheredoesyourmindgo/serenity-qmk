...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_ESC, KC_N, KC_R, KC_T, KC_S, KC_G, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_X, KC_Z, KC_M, KC_C, KC_B, KC_K, KC_P, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), LT(AUX,KC_SPC), ENC_BTN, LT(HRDWR,KC_SPC), MO(SYMBL), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), KC_RIGHT
    ),
    [QWRTY] = LAYOUT(
        KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
        KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, RSFT_T(KC_ENT),
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), LT(AUX,KC_SPC), ENC_BTN, LT(HRDWR,KC_SPC), MO(SYMBL), KC_SLSH, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	[NUMNAV] = LAYOUT(
        ...
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_SPC, ENC_BTN, KC_SPC, MO(SYMBL), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
	[SYMBL] = LAYOUT(
        ...
        KC_MUTE, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), KC_SPC, ENC_BTN, KC_SPC, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[AUX] = LAYOUT(
        ...
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), KC_SPC, ENC_BTN, LT(HRDWR,KC_SPC), MO(SYMBL), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [HRDWR] = LAYOUT(
        ...
        KC_MUTE, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), LT(AUX,KC_SPC), ENC_BTN, KC_SPC, MO(SYMBL), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[FUNC] = LAYOUT(
        KC_TAB, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, OS_BSPC,
        KC_ESC, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_QUOT,
    ...
    //      KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_SPC, KC_SPC, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, LLOCK
    // ),
	[OS] = LAYOUT(
    ...
    [MOUSE] = LAYOUT(
        ...
        KC_ESC, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LLOCK, QK_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_QUOT,
        KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, SHAKE_MOUSE, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, RSFT_T(KC_ENT),
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_SPC, ENC_BTN, KC_SPC, KC_NO, KC_RGUI, XOSM_RALT, KC_RCTL, KC_NO
    ),
};
