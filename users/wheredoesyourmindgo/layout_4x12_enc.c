...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LOWEST] = LAYOUT_4x12_enc(
        ...
        DF(BASE), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT,  DF(LOWEST), ENC_BTN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
    ),
	...
	[HIGHEST] = LAYOUT_4x12_enc(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, ENC_BTN, DF(HIGHEST), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DF(BASE)
    ),
	[OS] = LAYOUT_4x12_enc(
