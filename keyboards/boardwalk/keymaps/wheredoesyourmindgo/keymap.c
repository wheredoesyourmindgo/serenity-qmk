...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, TO(LOWEST), LT(LOWER,KC_ESC), LT(LOW,KC_ENT), /* <-2U  2U-> */ LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, TO(LOWEST), LT(LOWER,KC_ESC), LT(LOW,KC_ENT), /* <-2U  2U-> */ LT(HIGH,KC_TAB), LT(HIGHER_HRM,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    ...
    [LOWEST] = LAYOUT_ortho_2x2u(
        ...
        KC_NO,  XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, KC_NO, KC_NO,KC_NO, KC_NO, KC_NO, KC_WH_R, KC_WH_U, KC_WH_D, KC_WH_L, KC_RSFT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_NO, TO(BASE), KC_NO, /* <-2U  2U-> */ KC_NO, KC_NO, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
