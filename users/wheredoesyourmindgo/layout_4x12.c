...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_4x12(
        LALT(KC_DEL), OS_CLOSE_WIN, OS_CLOSE, WNDW_CNTR, WNDW_MAX, TD(TD_TGL_SEL), KC_APP, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSPC,
        TO(BASE_HRM), TLNG_LFT, TLNG_ILFT, TLNG_IRGHT, TLNG_RGHT, KC_NO, DF(HIGHER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
	...
	[HIGHER_HRM] = LAYOUT_4x12(
        LALT(KC_DEL), OS_CLOSE_WIN, OS_CLOSE, WNDW_CNTR, WNDW_MAX, TD(TD_TGL_SEL), KC_APP, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSPC,
        TO(BASE), TLNG_LFT, TLNG_ILFT, TLNG_IRGHT, TLNG_RGHT, KC_NO, DF(HIGHER_HRM), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        LSFT_T(KC_CAPS), UNDO, CUT, COPY, PASTE, REDO, KC_NO, VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
	...
	[OS] = LAYOUT_4x12(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,    OS_SCRN_SHT_OPT,  OS_LNCHPD, OS_TRM_VSR,     OS_SIRI,            OS_SDBR,        OS_MIN,
