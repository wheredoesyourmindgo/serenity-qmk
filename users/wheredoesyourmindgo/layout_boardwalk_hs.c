...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_X, KC_J, KC_H, KC_V, KC_Z, KC_LBRC, KC_RBRC, KC_Q, KC_W, KC_O, KC_U, KC_MINS, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_F, KC_HOME, KC_PGUP, KC_G, KC_D, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_Y, KC_L, KC_B, KC_M, KC_K, KC_END, KC_PGDN, KC_P, KC_C, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
