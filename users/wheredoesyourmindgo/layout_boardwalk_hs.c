...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_GRV, KC_S, KC_R, KC_N, KC_T, KC_F, KC_HOME, KC_PGUP, KC_P, KC_D, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_Y, KC_L, KC_B, KC_M, KC_K, KC_END, KC_PGDN, KC_G, KC_C, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
	...
	[LOWER] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGHER), KC_NO, KC_NO, KC_DOT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_EQL,
	...
	[LOW] = LAYOUT_boardwalk_hs(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH),KC_NO, KC_NO, KC_PIPE,   KC_LCBR, KC_LT, KC_GT, KC_RCBR, KC_EQL,
