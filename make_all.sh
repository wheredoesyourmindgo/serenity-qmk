...
# qmk compile -kb boardsource/technik_o -km wheredoesyourmindgo -j 2 -e QWERTY_BASE=no -e RGB_MATRIX_ENABLE=yes MOUSEKEY_ENABLE=no
...
# qmk compile -kb checkerboards/quark -km wheredoesyourmindgo $QMK_OPTS
