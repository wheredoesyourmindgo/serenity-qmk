...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        KC_DEL, KC_W, KC_L, KC_Y, KC_P, KC_K, KC_X, KC_F, KC_O, KC_U, KC_BSLS, KC_BSPC,
        LT(LOWEST, KC_GRV), KC_C, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_Q, KC_J, KC_V, KC_D, KC_Z, KC_B, KC_H, KC_SLSH, KC_COMM, KC_DOT, KC_RSFT,
    ...
    [QWRTY] = LAYOUT_4x12_enc(
        ...
        LT(LOWEST, KC_GRV), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
	...
	[LOW] = LAYOUT_4x12_enc(
        ...
        LT(LOWEST, KC_GRV), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_MINS, KC_COLON,  KC_EQL,  KC_LCBR, KC_RCBR, KC_QUOT,
        KC_LSFT, KC_LT, KC_GT, KC_DQUO, KC_COLN, KC_PLUS,                      KC_UNDS, KC_SCOLON, KC_PLUS, KC_LBRC, KC_RBRC, KC_CAPS,
    ...
    [LOWEST] = LAYOUT_4x12_enc(
        ...
        KC_GRV, KC_NO, KC_NO, KC_NO, KC_NO, LLOCK, KC_LOCK, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO,
