...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[NUMNAV] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE, KC_MINS), XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, KC_NO, KC_NO, DOT_LP, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_QUOT,
	...
	[AUX] = LAYOUT_ortho_2x2u(
        ...
        LT(MOUSE, KC_MINS), WNDW_LP_MAX, WNDW_LP_SMLR, WNDW_LP_LGR, WNDW_LP_CNTR, WNDW_LP_RST, KC_NO, KC_NO, LLOCK, KC_LSFT, KC_LGUI, KC_LALT, KC_LCTL, KC_QUOT,
        KC_LSFT, UNDO, CUT, COPY, PASTE, REDO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
