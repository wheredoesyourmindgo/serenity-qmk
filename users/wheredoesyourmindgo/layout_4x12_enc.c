...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        ...
        KC_DEL, KC_X, KC_Y, KC_C, KC_W, KC_P, KC_J, KC_L, KC_U, KC_SCLN, KC_Z, KC_BSPC,
        KC_QUOT, KC_R, KC_I, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_A, KC_O, KC_MINS,
        TD(TD_CAPS_WORD), KC_K, KC_Q, KC_F, KC_D, KC_B, KC_V, KC_H, KC_SLSH, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
        ...
        KC_DEL, KC_X, KC_L, KC_D, KC_V, KC_K, KC_Z, KC_W, KC_O, KC_U, KC_SCLN, KC_BSPC,
        KC_GRV, KC_S, KC_R, KC_T, KC_N, KC_F, KC_G, KC_Y, KC_E, KC_I, KC_A, KC_MINS,
        TD(TD_CAPS_WORD), KC_Q, KC_J, KC_M, KC_H, KC_B, KC_P, KC_C, KC_QUOT, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
        TD(TD_OOPSY), KC_LCTL, KC_LALT, KC_LGUI, TD(TD_LOWER_ESC), TD(TD_LOW_ENT), ENC_BTN, LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), LT(HIGHEST,KC_RIGHT)
    #else
	...
	[LOW] = LAYOUT_4x12_enc(
        ...
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW), KC_TILD, KC_BSLS, KC_PLUS, KC_LBRC, KC_RBRC,  KC_RSFT,
    ...
    [HIGH] = LAYOUT_4x12_enc(
        ...
        KC_NO, KC_NO, KC_VOLD, KC_VOLU, KC_NO, KC_MUTE, OSL(LOW), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DEBUG,
