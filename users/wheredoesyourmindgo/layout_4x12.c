...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_4x12(
        LALT(KC_DEL), OS_PRV_TAB, KC_NO, KC_NO, OS_NXT_TAB, TD(TD_TGL_SEL), KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSPC,
        KC_GRV,  TLNG_LFT, TLNG_ILFT,  TLNG_IRGHT, TLNG_RGHT, XWNDW_MAX, DF(HIGHER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        LSFT_T(KC_CAPS), OS_PRVS_APP_WNDW, KC_NO, KC_NO, OS_NXT_APP_WNDW, WNDW_CNTR, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
