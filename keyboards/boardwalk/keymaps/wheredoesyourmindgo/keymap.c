...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[LOWER] = LAYOUT_ortho_2x2u(
        ...
        KC_LSFT, KC_NO        , OSM(MOD_RALT)      , KC_NO        , KC_NO        , KC_NO    ,         KC_NO, KC_NO,       KC_NO  , KC_HOME, KC_PGDN, KC_PGUP, KC_END, TD(TD_RSFT_T_CAPS),
	...
	[HIGHER] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_LSFT_T_CAPS), LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), SGUI(KC_Z), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
