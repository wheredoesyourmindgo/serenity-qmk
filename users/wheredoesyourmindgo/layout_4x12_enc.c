...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER_HRM] = LAYOUT_4x12_enc(
        ...
        LSFT_T(KC_CAPS), UNDO, CUT, COPY, PASTE, REDO, KC_NO, VOID, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, TD(TD_LOWER_ESC), KC_ENT,KC_TRNS, KC_TAB, DF(BASE_HRM), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
    [HIGH] = LAYOUT_4x12_enc(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_ESC,  KC_ENT,KC_TRNS, DF(BASE), KC_NO, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
