...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[AUX] = LAYOUT(
        ...
        KC_ESC, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, LLOCK, WNDW_LP_MAX, WNDW_LP_CNTR, WNDW_LP_SMLR, WNDW_LP_LGR, WNDW_LP_RST, KC_SCLN,
	...
	[OS] = LAYOUT(
        ...
        KC_ESC, PRV_APP, CMD_TAB_PRV, CMD_TAB_NXT, OS_EXPOSE, OS_DOCK, OS_FLLSCRN, OS_MSN_CNTRL, OS_PRV_SPC, OS_NXT_SPC, OS_DSKTP, KC_SCLN,
