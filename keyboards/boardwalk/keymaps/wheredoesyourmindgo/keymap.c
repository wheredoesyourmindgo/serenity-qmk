...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_ESC), LT(LOW,KC_SPC), /* <-2U  2U-> */ LT(HIGH,KC_ENT), LT(HIGHER,KC_TAB), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, MO(LOWEST), LT(LOWER,KC_ESC), LT(LOW,KC_SPC), /* <-2U  2U-> */ LT(HIGH,KC_ENT), LT(HIGHER_HRM,KC_TAB), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    // Having LT(HIGHER,KC_TAB) allows quick toggle select when arrowing with Lower layer
	[LOWER] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT        , DF(BASE)     , KC_SPC   , KC_ENT, LT(HIGHER,KC_TAB),  KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	[LOW] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT,        KC_NO        , DF(BASE), /* <-2U  2U-> */ KC_NO, KC_TAB,  KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	...
	[HIGHER] = LAYOUT_ortho_2x2u(
        ...
        KC_GRV, TO(BASE_HRM), KC_CAPS, KC_LEAD, OSHR, KC_APP,  KC_NO, KC_NO, DF(HIGHER), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        KC_LSFT, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), SGUI(KC_Z), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, LT(LOWER,KC_ESC), KC_SPC, /* <-2U  2U-> */ KC_ENT, DF(BASE), KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	[HIGHER_HRM] = LAYOUT_ortho_2x2u(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        LALT(KC_DEL), APP4, APP3, APP1, APP2, TD(TD_TGL_SEL), KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_NO,
        KC_GRV, TO(BASE), KC_CAPS, KC_LEAD, OSHR, KC_APP,  KC_NO, KC_NO, DF(HIGHER_HRM), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, KC_NO,
        KC_LSFT, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), SGUI(KC_Z), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OSM(MOD_RALT), KC_NO, KC_RSFT,
    ...
    [HIGH] = LAYOUT_ortho_2x2u(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_ESC, KC_NO,  /* <-2U  2U-> */ DF(BASE), KC_NO, KC_RSFT, KC_RGUI, KC_RALT, KC_RCTL
    ),
	...
	[WNDW] = LAYOUT_ortho_2x2u(
        ...
        KC_NO, KC_NO , KC_NO , KC_NO,  DF(BASE), WNDW_ALMST_MAX, WNDW_VRT_MAX, KC_NO, KC_NO, KC_NO  , KC_NO      , KC_NO
    )
};
