...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[OS] = LAYOUT_4x12(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OS_SCRN_SHT_OPT, OS_APP_WNDWS, OS_PRVS_APP_WNDW, OS_NXT_APP_WNDW, OS_SDBR, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OS_SIRI, OS_SPTLGHT, CMD_TAB_PRV, CMD_TAB_NXT, PRV_APP, OS_LNCHPD,
        KC_NO, KC_NO, KC_NO, KC_NO, VOID, KC_NO, OS_DSKTP, OS_MSN_CNTRL, OS_PRV_SPC, OS_NXT_SPC, OS_FLLSCRN, KC_NO,
