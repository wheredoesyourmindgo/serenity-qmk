...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_K, KC_Y, KC_C, KC_W, KC_P, KC_LBRC, KC_RBRC, KC_J, KC_L, KC_U, KC_Q, KC_SCLN, KC_BSPC,
        KC_MINS, KC_R, KC_I, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP,  KC_M, KC_N, KC_E, KC_A, KC_O, KC_QUOT,
        TD(TD_CAPS_WORD), KC_Z, KC_X, KC_F, KC_D, KC_B, KC_END, KC_PGDN, KC_V, KC_H, KC_COMM, KC_DOT, KC_SLSH, TD(TD_CAPS_SENTENCE),
