...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //     KC_DEL , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINUS, KC_7, KC_8 , KC_9, KC_SLSH, KC_BSPC,
    //     KC_NO, KC_NO, KC_LPRN, KC_RPRN, KC_NO, LLOCK, KC_PLUS, KC_4, KC_5, KC_6, KC_ASTR, QUOT_LP,
    //     KC_LSFT, KC_NO, KC_LT, KC_GT, KC_NO, KC_NO, KC_0, KC_1, KC_2, KC_3, KC_DOT, KC_EQL,
    //     LT(FUNC,KC_MUTE), KC_LCTL, KC_LALT, KC_LGUI, LT(NUMNAV,KC_ESC), LT(SYMBL,KC_ENT), KC_SPC, LT(AUX,KC_TAB), KC_DLR, KC_CIRC, KC_PERC, KC_NO
    // ),
    ...
    [MOUSE] = LAYOUT_ortho_4x12(
        ...
        LT(FUNC,KC_MUTE), KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, KC_SPC, KC_TAB, KC_RGUI, XOSM_RALT, KC_RCTL, KC_NO
    ),
