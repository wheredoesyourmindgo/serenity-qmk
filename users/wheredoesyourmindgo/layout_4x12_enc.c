...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_4x12_enc(
        ...
        KC_DEL, KC_X, KC_Y, KC_F, KC_W, KC_B, KC_J, KC_L, KC_U, KC_SCLN, KC_Z, KC_BSPC,
        KC_QUOT, KC_R, KC_I, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_A, KC_O, KC_MINS,
        TD(TD_CAPS_WORD), KC_K, KC_Q, KC_F, KC_D, KC_P, KC_V, KC_H, KC_SLSH, KC_COMM, KC_DOT, TD(TD_CAPS_SENTENCE),
	...
	[LOW] = LAYOUT_4x12_enc(
        ...
        KC_NO, XOSM_LCTL, XOSM_LALT, XOSM_LGUI, XOSM_LSFT, OSL(HIGH), KC_GRV, KC_EQL, KC_BSLS, KC_LCBR, KC_RCBR,  KC_NO,
        KC_LSFT, KC_NO, OSM(MOD_RALT), KC_NO, VOID, DF(LOW), KC_TILD, KC_PLUS, KC_PIPE, KC_LBRC, KC_RBRC,  KC_RSFT,
