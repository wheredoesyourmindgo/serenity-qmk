...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        LT(OS,KC_GRV), ALPH_R2C1, KC_R, KC_S, KC_T, KC_G, KC_HOME, KC_PGUP,  KC_M, KC_N, KC_E, KC_I, ALPH_R2C10, KC_QUOT,
    ...
    [BASE_QWRTY] = LAYOUT_boardwalk_hs(
        ...
        LT(OS,KC_GRV), KC_A, KC_S, KC_D, KC_F, KC_G, KC_HOME, KC_PGUP,  KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
	...
	[OS] = LAYOUT_boardwalk_hs(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,KC_NO, KC_NO, KC_NO, OS_SCRN_SHT_OPT, OS_SPTLGHT, OS_LNCHPD, OS_SIRI, OS_SDBR, CMD_TAB_QUIT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OS_FLLSCRN, OS_PRV_SPC, OS_DSKTP, OS_MSN_CNTRL, OS_NXT_SPC, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OS_DOCK, CMD_TAB_PRV, PRV_APP, OS_EXPOSE, CMD_TAB_NXT, KC_NO,
