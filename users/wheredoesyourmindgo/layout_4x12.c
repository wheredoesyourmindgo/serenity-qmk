...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[HIGHER] = LAYOUT_4x12(
        LALT(KC_DEL), KC_NO, WNDW_SMLLR, WNDW_LRGR, KC_NO,  WNDW_RSTR, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_INS, KC_BSPC,
        KC_GRV,  OS_PRV_TAB, OS_PRVS_APP_WNDW,  OS_NXT_APP_WNDW, OS_NXT_TAB,WNDW_MAX, DF(HIGHER), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        LSFT_T(KC_CAPS), WNDW_LFT_HLF, WNDW_BTTM_HLF, WNDW_TOP_HLF, WNDW_RGHT_HLF, XWNDW_CNTR, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT,
        KC_NO, KC_NO, KC_NO, KC_NO, TD(TD_LOWER_ESC), KC_ENT, KC_TAB, DF(BASE), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
    [HIGH] = LAYOUT_4x12(
        KC_DEL, KC_NO, DISP_DIM, DISP_BRI, KC_NO, OS_DRKMD_TGL, RGB_TOG, KC_NO, RGB_HUD, RGB_HUI, KC_NO, RESET,
        KC_GRV, KC_NO, KC_VOLD, KC_VOLU, KC_NO, KC_MUTE, DF(HIGH), RGB_RMOD, RGB_VAD, RGB_VAI, RGB_MOD, DEBUG,
        KC_LSFT, KC_MRWD, MAC_MSTP, KC_MPLY, KC_MFFD, TGL_LYT, KC_NO, KC_NO, RGB_SAD, RGB_SAI, KC_NO, KC_RSFT,
	...
	[HIGHEST] = LAYOUT_4x12(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_ESC, KC_ENT, DF(HIGHEST), XOSM_LSFT, XOSM_LGUI, XOSM_LALT, XOSM_LCTL, DF(BASE)
    ),
	[OS] = LAYOUT_4x12(
        CMD_TAB_HIDE, KC_NO, OS_SCRN_SHT, OS_SCRN_SHT_SLCT, KC_NO, OS_SCRN_SHT_OPT, OS_SPTLGHT, OS_LNCHPD, OS_SIRI, OS_SDBR, TD(TD_TGL_SEL), CMD_TAB_QUIT,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, OS_FLLSCRN, OS_PRV_SPC, OS_DSKTP, OS_MSN_CNTRL, OS_NXT_SPC, OS_SDBR,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, PRV_APP, CMD_TAB_PRV, OS_DOCK, OS_EXPOSE, CMD_TAB_NXT, KC_NO,
