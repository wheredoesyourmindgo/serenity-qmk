...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        LT(MOUSE,KC_ESC), KC_N, KC_R, KC_T, KC_S, KC_G, KC_Y, KC_H, KC_E, KC_I, KC_A, KC_QUOT,
        KC_LSFT, KC_X, KC_Z, KC_M, KC_C, KC_B, KC_K, KC_P, KC_SLSH, KC_COMM, KC_DOT, RSFT_T(KC_ENT),
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), LT(AUX,KC_SPC), LT(HRDWR,KC_SPC), MO(SYMBL), RGUI_T(KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_UP), KC_RIGHT
    ),
    [QWRTY] = LAYOUT(
        ...
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), LT(AUX,KC_SPC), LT(HRDWR,KC_SPC), MO(SYMBL), KC_SLSH, KC_LEFT, KC_DOWN, KC_RIGHT
    ),
	[NUMNAV] = LAYOUT(
        ...
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_SPC, KC_SPC, MO(SYMBL), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [SYMBL] = LAYOUT(
        ...
        KC_MUTE, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), KC_SPC, KC_SPC, KC_NO, KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[AUX] = LAYOUT(
        ...
        KC_MUTE, KC_LCTL, KC_LALT, KC_LGUI, MO(NUMNAV), KC_SPC, LT(HRDWR,KC_SPC), MO(SYMBL), KC_NO, XOSM_RALT, KC_NO, KC_NO
    ),
    [HRDWR] = LAYOUT(
        ...
        KC_MUTE, KC_NO, XOSM_RALT, KC_NO, MO(NUMNAV), LT(AUX,KC_SPC), KC_SPC, MO(SYMBL), KC_RGUI, KC_RALT, KC_RCTL, KC_NO
    ),
	[FUNC] = LAYOUT(
    ...
    [MOUSE] = LAYOUT(
        ...
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_SPC, KC_SPC, KC_NO, KC_RGUI, XOSM_RALT, KC_RCTL, KC_NO
    ),
};
