...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), TD(TD_LOWER_ESC), LT(LOW,KC_ENT), /* <-2U  2U-> */ LT(HIGH,KC_TAB), LT(HIGHER,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
    [BASE_HRM] = LAYOUT_ortho_2x2u(
        ...
        TD(TD_OOPSY), KC_LALT, KC_LGUI, MO(LOWEST), TD(TD_LOWER_ESC), LT(LOW,KC_ENT), /* <-2U  2U-> */ LT(HIGH,KC_TAB), LT(HIGHER_HRM,KC_SPC), LT(HIGHEST,KC_LEFT), RGUI_T(KC_DOWN), RALT_T(KC_UP), RCTL_T(KC_RIGHT)
    ),
