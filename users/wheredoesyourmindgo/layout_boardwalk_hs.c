...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_boardwalk_hs(
        ...
        KC_DEL, KC_V, KC_L, KC_M, KC_F, KC_Q, KC_LBRC, KC_RBRC, KC_X, KC_W, KC_O, KC_U, KC_MINS, KC_BSPC,
        LT(LOWEST, KC_GRV), KC_S, KC_R, KC_T, KC_N, KC_P, KC_HOME, KC_PGUP, KC_Y, KC_D, KC_E, KC_I, KC_A, KC_EQL,
        KC_LSFT, KC_Z, KC_J, KC_K, KC_H, KC_B, KC_END, KC_PGDN, KC_G, KC_C, KC_QUOT, KC_COMM, KC_DOT, KC_RSFT,
